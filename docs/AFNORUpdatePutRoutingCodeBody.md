...
`address` | [AFNORAddressPut](AFNORAddressPut.md)

## Example

```typescript
import type { AFNORUpdatePutRoutingCodeBody } from ''
...
const example = {
  ...
  "address": null,
} satisfies AFNORUpdatePutRoutingCodeBody
...
const exampleParsed = JSON.parse(exampleJSON) as AFNORUpdatePutRoutingCodeBody
