...
```typescript
import type { FactureElectroniqueModelsInvoiceTypeCode } from ''

// TODO: Update the object below with actual values
const example = {
} satisfies FactureElectroniqueModelsInvoiceTypeCode
...
const exampleParsed = JSON.parse(exampleJSON) as FactureElectroniqueModelsInvoiceTypeCode
