...
**locality** | **string** | Corresponds to the municipality of the recipient structure having defined the directory line(s). | [optional] [default to undefined]
**codePays** | **string** | Corresponds to the country code of the recipient structure | [optional] [default to undefined]

## Example

```typescript
import { AFNORAddressPatch } from '@factpulse/sdk';

const instance: AFNORAddressPatch = {
    ligneAdresse1,
    ligneAdresse2,
    ligneAdresse3,
    postalCode,
