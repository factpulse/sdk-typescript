 ...
 */
export function instanceOfProductCharacteristic(value: object): value is ProductCharacteristic {
...
export function ProductCharacteristicToJSON(json: any): ProductCharacteristic {
    return ProductCharacteristicToJSONTyped(json, false);
}

export function ProductCharacteristicToJSONTyped(value?: ProductCharacteristic | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
