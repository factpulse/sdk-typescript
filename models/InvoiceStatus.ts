 ...
 */
export function instanceOfInvoiceStatus(value: object): value is InvoiceStatus {
...
export function InvoiceStatusToJSON(json: any): InvoiceStatus {
    return InvoiceStatusToJSONTyped(json, false);
}

export function InvoiceStatusToJSONTyped(value?: InvoiceStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
