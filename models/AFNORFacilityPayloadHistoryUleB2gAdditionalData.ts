 ...
 * 
 * @export
 * @interface AFNORFacilityPayloadHistoryUleB2gAdditionalData
 */
export interface AFNORFacilityPayloadHistoryUleB2gAdditionalData {
    /**
     ...
     * @type {boolean}
     * @memberof AFNORFacilityPayloadHistoryUleB2gAdditionalData
     */
    pm?: boolean;
    /**
...
/**
 * Check if a given object implements the AFNORFacilityPayloadHistoryUleB2gAdditionalData interface.
 */
export function instanceOfAFNORFacilityPayloadHistoryUleB2gAdditionalData(value: object): value is AFNORFacilityPayloadHistoryUleB2gAdditionalData {
    return true;
}

export function AFNORFacilityPayloadHistoryUleB2gAdditionalDataFromJSON(json: any): AFNORFacilityPayloadHistoryUleB2gAdditionalData {
    return AFNORFacilityPayloadHistoryUleB2gAdditionalDataFromJSONTyped(json, false);
}

export function AFNORFacilityPayloadHistoryUleB2gAdditionalDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): AFNORFacilityPayloadHistoryUleB2gAdditionalData {
    if (json == null) {
        return json;
    }
    return {
...
export function AFNORFacilityPayloadHistoryUleB2gAdditionalDataToJSON(json: any): AFNORFacilityPayloadHistoryUleB2gAdditionalData {
    return AFNORFacilityPayloadHistoryUleB2gAdditionalDataToJSONTyped(json, false);
}

export function AFNORFacilityPayloadHistoryUleB2gAdditionalDataToJSONTyped(value?: AFNORFacilityPayloadHistoryUleB2gAdditionalData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
