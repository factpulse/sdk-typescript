...
export function instanceOfUnitOfMeasure(value: any): boolean {
    for (const key in UnitOfMeasure) {
        if (Object.prototype.hasOwnProperty.call(UnitOfMeasure, key)) {
            if (UnitOfMeasure[key as keyof typeof UnitOfMeasure] === value) {
                return true;
            }
        }
    }
...
export function UnitOfMeasureToJSONTyped(value: any, ignoreDiscriminator: boolean): UnitOfMeasure {
