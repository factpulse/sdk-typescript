 ...
 */
export function instanceOfPaymentCard(value: object): value is PaymentCard {
    return true;
}
...
export function PaymentCardToJSON(json: any): PaymentCard {
    return PaymentCardToJSONTyped(json, false);
}

export function PaymentCardToJSONTyped(value?: PaymentCard | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
