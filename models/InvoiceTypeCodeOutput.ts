 ...
 * @export
 */
export const InvoiceTypeCodeOutput = {
    /**
    * Commercial Invoice
    */
    INVOICE: '380',
...
export type InvoiceTypeCodeOutput = typeof InvoiceTypeCodeOutput[keyof typeof InvoiceTypeCodeOutput];


export function instanceOfInvoiceTypeCodeOutput(value: any): boolean {
    for (const key in InvoiceTypeCodeOutput) {
        if (Object.prototype.hasOwnProperty.call(InvoiceTypeCodeOutput, key)) {
            if (InvoiceTypeCodeOutput[key as keyof typeof InvoiceTypeCodeOutput] === value) {
                return true;
            }
        }
    }
...
export function InvoiceTypeCodeOutputFromJSON(json: any): InvoiceTypeCodeOutput {
    return InvoiceTypeCodeOutputFromJSONTyped(json, false);
}

export function InvoiceTypeCodeOutputFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvoiceTypeCodeOutput {
    return json as InvoiceTypeCodeOutput;
}

export function InvoiceTypeCodeOutputToJSON(value?: InvoiceTypeCodeOutput | null): any {
    return value as any;
}

export function InvoiceTypeCodeOutputToJSONTyped(value: any, ignoreDiscriminator: boolean): InvoiceTypeCodeOutput {
    return value as InvoiceTypeCodeOutput;
}
