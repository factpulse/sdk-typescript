...
export function instanceOfSchemeID(value: any): boolean {
    for (const key in SchemeID) {
        if (Object.prototype.hasOwnProperty.call(SchemeID, key)) {
            if (SchemeID[key as keyof typeof SchemeID] === value) {
                return true;
            }
        }
    }
...
export function SchemeIDFromJSON(json: any): SchemeID {
    return SchemeIDFromJSONTyped(json, false);
}

export function SchemeIDFromJSONTyped(json: any, ignoreDiscriminator: boolean): SchemeID {
    return json as SchemeID;
}

export function SchemeIDToJSON(value?: SchemeID | null): any {
    return value as any;
}

export function SchemeIDToJSONTyped(value: any, ignoreDiscriminator: boolean): SchemeID {
    return value as SchemeID;
}
