...
/**
 * Check if a given object implements the AFNORAddressRead interface.
 */
export function instanceOfAFNORAddressRead(value: object): value is AFNORAddressRead {
    return true;
}

export function AFNORAddressReadFromJSON(json: any): AFNORAddressRead {
    return AFNORAddressReadFromJSONTyped(json, false);
}

export function AFNORAddressReadFromJSONTyped(json: any, ignoreDiscriminator: boolean): AFNORAddressRead {
    if (json == null) {
        return json;
    }
    return {
...
export function AFNORAddressReadToJSON(json: any): AFNORAddressRead {
    return AFNORAddressReadToJSONTyped(json, false);
}

export function AFNORAddressReadToJSONTyped(value?: AFNORAddressRead | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
