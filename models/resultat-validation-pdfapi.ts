...
// @ts-ignore
import type { InformationSignatureAPI } from './information-signature-api';

/**
 * Résultat complet de la validation d\'un PDF Factur-X.
 */
export interface ResultatValidationPDFAPI {
    /**
    ...
    'profil_xmp'?: string | null;
    'version_xmp'?: string | null;
    /**
     ...
     */
    'metadonnees_xmp'?: { [key: string]: any; };
    /**
