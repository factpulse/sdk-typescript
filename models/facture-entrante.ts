...
// @ts-ignore
import type { FormatFacture } from './format-facture';
// May contain unused imports in some cases
// @ts-ignore
import type { FournisseurEntrant } from './fournisseur-entrant';
// May contain unused imports in some cases
// @ts-ignore
import type { TypeDocument } from './type-document';
...
export interface FactureEntrante {
    ...
    'site_facturation_siret'?: string | null;
    /**
