...
// May contain unused imports in some cases
// @ts-ignore
import type { SignatureInfo } from './signature-info';

/**
 * Réponse complète après soumission automatisée.
 */
export interface SoumettreFactureCompleteResponse {
    /**
     ...
     * Type de destination
     */
    'destination_type': SoumettreFactureCompleteResponseDestinationTypeEnum;
    'resultat_chorus'?: ResultatChorusPro | null;
    'resultat_afnor'?: ResultatAFNOR | null;
    /**
...
export const SoumettreFactureCompleteResponseDestinationTypeEnum = {
    ChorusPro: 'chorus_pro',
    Afnor: 'afnor'
} as const;

export type SoumettreFactureCompleteResponseDestinationTypeEnum = typeof SoumettreFactureCompleteResponseDestinationTypeEnum[keyof typeof SoumettreFactureCompleteResponseDestinationTypeEnum];
