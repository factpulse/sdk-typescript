...
export function instanceOfDocType(value: any): boolean {
    for (const key in DocType) {
        if (Object.prototype.hasOwnProperty.call(DocType, key)) {
            if (DocType[key as keyof typeof DocType] === value) {
                return true;
            }
        }
    }
...
export function DocTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): DocType {
