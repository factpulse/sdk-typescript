...
// May contain unused imports in some cases
// @ts-ignore
import type { DonneesFactureSimplifiees } from './donnees-facture-simplifiees';
// May contain unused imports in some cases
// @ts-ignore
import type { OptionsProcessing } from './options-processing';
// May contain unused imports in some cases
// @ts-ignore
import type { ParametresSignature } from './parametres-signature';
 ...
 */
export interface SoumettreFactureCompleteRequest {
    /**
    ...
    'signature'?: ParametresSignature | null;
    /**
